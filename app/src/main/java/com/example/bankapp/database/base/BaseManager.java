package com.example.bankapp.database.base;
...
import com.example.bankapp.database.DaoMaster;
import com.example.bankapp.database.DaoSession;
import com.example.bankapp.database.interfaces.IDataBase;
...
public abstract class BaseManager<M, K> implements IDataBase<M, K> {
    ...
    public static final String DEFAULT_DATABASE_NAME = "bank.db";
