...
public class YuntxNotifyReceiver extends ECNotifyReceiver {
    ...
    public void onNotificationClicked(Context context, int notifyType, String sender) {
        Log.e("ECSDK_Demo.YuntxNotifyReceiver", "onNotificationClicked notifyType " + notifyType + " ,sender " + sender);
...
//                    Log.d(TAG, "receive call event ");
//                    Intent call = new Intent(this, VoiceView.class);
