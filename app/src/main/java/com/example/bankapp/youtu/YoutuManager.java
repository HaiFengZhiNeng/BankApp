...
//    public static String GROUP_ID = "Delivery-master";
    ...
    public static String APP_ID = "10101079";//"10098751";
    public static String SECRET_ID = "AKIDyoPmvp8u51iDToEpTt9AxWrwoSr0ne5H";//"AKIDLVQ6XjvMnzxf6HcrGQKyLRHrBxUmZdCV";
    public static String SECRET_KEY = "5uTmoc9RSErFOJzQddPvHZgYCbmiPr65";//"C9qIVTCfuue9PQCiz2rRlriKhphKirkN";
...
//        mGroupId.add(FfbApp.getInstance().getString(R.string.app_name));
//        return mGroupId;
//    }
