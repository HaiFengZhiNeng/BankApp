...
import com.example.bankapp.util.Base64Util;
...
public class YoutuSign {
     ...
     * @return 0表示成功
     */
    public static int appSign(String appId, String secret_id, String secret_key, long expired, StringBuffer mySign) {

        return appSignBase(appId, secret_id, secret_key, expired, "3041722595", mySign);
    }

    private static int appSignBase(String appId, String secret_id, String secret_key, long expired, String userid, StringBuffer mySign) {
